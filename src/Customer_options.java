...
public class Customer_options extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        buttonMenu24.setText("ADD CUSTOMER");
        ...
        buttonMenu16.setText("BY REGION");
        ...
        buttonMenu17.setText("SHOW ALL CUSTOMERS");
        ...
        buttonMenu18.setText("SEARCH CUSTOMER");
    ...
    private void buttonMenu24buttonMenu14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMenu24buttonMenu14ActionPerformed
        Main_frame.showForm(new Add_customer());
    }//GEN-LAST:event_buttonMenu24buttonMenu14ActionPerformed

    private void buttonMenu16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMenu16ActionPerformed
        Main_frame.showForm(new by_region_cus());
    }//GEN-LAST:event_buttonMenu16ActionPerformed

    private void buttonMenu17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMenu17ActionPerformed
        Main_frame.showForm(new Show_allcus());
    }//GEN-LAST:event_buttonMenu17ActionPerformed

    private void buttonMenu19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMenu19ActionPerformed
        Main_frame.showForm(new Search_cust(0,1));
    }//GEN-LAST:event_buttonMenu19ActionPerformed

    private void buttonMenu18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMenu18ActionPerformed
        Main_frame.showForm(new Search_cust(1,0));
    }//GEN-LAST:event_buttonMenu18ActionPerformed

    private void exitExit(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exitExit

    }//GEN-LAST:event_exitExit
    ...
    private resources.swing.ButtonMenu buttonMenu23;
