 ...
 * @author hp
 */
public class category_all extends javax.swing.JPanel {
    ...
    public category_all() {
        initComponents();
        String sql = "select CategoryType,CategoryDescription from Category";
        ...
        trans3.setLayout(new MigLayout("wrap 3, fillx, inset 3", "[fill][fill]", "[]0[]"));
        ...
        try (Connection con = DriverManager.getConnection(url, user, pass);
            ...
            while (rs.next()) {
                ...
                trans3.add(new catego_show(name,name,name,des));
            }
            if(p==0){
