...
public class All_employs extends javax.swing.JPanel {

    /**
     * Creates new form Show_allcus
     */
    public All_employs() {
        String sql = "SELECT SalesRepID,SalesRepName,Title,SalesRepContactInfo,SalesRepAddress,SalesRepRegionId,ReportsTo from [Sales Representative];";
        ...
        try (Connection con = DriverManager.getConnection(url, user, pass);
            ...
            while (rs.next()) {
                pane_cus.add(new employ_show_case(rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7)));
            }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("All Sales Representative");
