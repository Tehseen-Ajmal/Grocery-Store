...
public class Edit_cus extends javax.swing.JPanel {
            ...
            int g = 0;
                ...
                try (ResultSet rs = pstmt.executeQuery()) {
                        if (rs.next()) {
                            ...
                            email_person2.setText(rs.getString(2));
                            email_person3.setText(rs.getString(3));
                            email_person4.setText(rs.getString(4));
                            email_person5.setText(rs.getString(5));
                            email_person6.setText(rs.getString(6));
                            email_person8.setText(rs.getString(7));
                            email_person7.setText(rs.getString(8));
    ...
    private void initComponents() {
        ...
        button1.setText("Update customer");
        ...
        if(email_person8.getText().length()>0 && !isNumeric){
            ...
            try (Connection con = DriverManager.getConnection(url, user, pass)) {
                ...
                try (PreparedStatement pstmt = con.prepareStatement(sql)) {
                    pstmt.setString(1, email_person1.getText());
                    pstmt.setString(2, email_person2.getText());
                    pstmt.setString(3, email_person3.getText());
                    pstmt.setString(4, email_person4.getText());
                    pstmt.setString(5, email_person5.getText());
                    pstmt.setString(6, email_person6.getText());
                    pstmt.setString(7, email_person8.getText());  // Corrected the order of parameters
                    pstmt.setString(8, email_person7.getText());  // Corrected the order of parameters
                    pstmt.setString(9, c_id);  // Assuming primaryKey holds the CustomerID value
                    ...
                    if (rowsUpdated > 0) {
                        ...
                        JOptionPane.showMessageDialog(jPanel4, "Data Updated...", "Information", JOptionPane.INFORMATION_MESSAGE);
                        Main_frame.showForm(new Customer_options());
                    } else {
                ...
                throw new RuntimeException("Error connecting to the database or executing the update statement.", e);
            }
        }
