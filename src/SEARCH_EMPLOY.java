 ...
 * @author hp
 */
public class SEARCH_EMPLOY extends javax.swing.JPanel {
    ...
    int calling;
    int comp;
    public SEARCH_EMPLOY(int c,int call) {
        comp=c;
        calling=call;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        email_person1.setHint("Enter Employee ID to search Employee...");
        ...
        jButton2.setToolTipText("Go to Employee");
        ...
        if (calling == 0) {
            add_per.setLabel("Search Employee");
        } else if (calling==1) {
            add_per.setLabel("Update Employee");
        }
    ...
    private void add_perActionPerformed(java.awt.event.ActionEvent evt) {
        if(comp==0){
            Main_frame.showForm(new edit_emply(email_person1.getText()));
        }else {
            Main_frame.showForm(new search_emp_out(email_person1.getText()));
        }
    }
