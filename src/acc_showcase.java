...
public class acc_showcase extends javax.swing.JPanel {
    ...
    String region;
    String postal;
    public acc_showcase(String p,String na,String cont,String typ,String adrr, String regio,String posta) {
        name = na;
        pk = p;
        contact = cont;
        type = typ;
