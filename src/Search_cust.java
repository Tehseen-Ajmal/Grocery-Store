 ...
 * @author hp
 */
public class Search_cust extends javax.swing.JPanel {
    ...
    int calling;
    int comp;
    public Search_cust(int c,int call) {
        comp=c;
        calling=call;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        email_person1.setHint("Enter customer ID to search customer...");
        ...
        jButton2.setToolTipText("Go to Customers");
        ...
        if (calling == 0) {
            add_per.setLabel("Search Customer");
        } else if (calling==1) {
            add_per.setLabel("Update Customer");
        }
    ...
    private void add_perActionPerformed(java.awt.event.ActionEvent evt) {
        if(comp==0){
            Main_frame.showForm(new Edit_cus(email_person1.getText()));
        }else {
            Main_frame.showForm(new search_out_cs(email_person1.getText()));
        }
    }
