...
public class Update_employ extends javax.swing.JPanel {
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try (Connection con = DriverManager.getConnection(url, user, pass)) {
            ...
            try (PreparedStatement pstmt = con.prepareStatement(sql)) {
                ...
                pstmt.setString(1, "SR"+nextPrimaryKey);
                pstmt.setString(2, email_person1.getText());//email_person1.setText();
                pstmt.setString(3, (String) jComboBox1.getSelectedItem());//jComboBox1.setModel();
