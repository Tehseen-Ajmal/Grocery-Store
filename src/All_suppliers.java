...
public class All_suppliers extends javax.swing.JPanel {

    /**
     * Creates new form Show_allcus
     */
    public All_suppliers() {
        String[][] d = {{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"},{"name","roll","email"}};
        String[] c = {"N","R","E"};
        JTable table = new JTable(d,c);


        initComponents();
        pane_cus.setLayout(new MigLayout("wrap, fillx, inset 3", "[fill]", "[]0[]"));
        for(int i=0;i<=10;i++){
            pane_cus.add(new acc_showcase("C"+i,"Tehseen Ajmal","0128312983","Type","post office","north","12345"));
//jList1.add(new Person_show_case("Name"+i));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        Main_frame.showForm(new suplier_options());
    }
